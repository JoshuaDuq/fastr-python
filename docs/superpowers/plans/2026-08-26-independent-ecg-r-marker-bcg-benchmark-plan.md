...
- Comparative evidence does not justify assuming that OBS is superior to AAS: one software comparison found a small individual-level AAS advantage, while a later seven-method study found residual artifacts and signal loss after every tested software correction. The benchmark must therefore evaluate both attenuation and signal preservation without a priori ranking: [Harrison et al.](https://pubmed.ncbi.nlm.nih.gov/25403874/), [Gallego-Rudolf et al.](https://doi.org/10.3389/fnins.2022.951321).
